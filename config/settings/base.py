...
# main_service_of_plotters/
APPS_DIR = ROOT_DIR / "main_service_of_plotters"
env = environ.Env()
...
LANGUAGE_CODE = "en-us"
# Languages whisch our site support
LANGUAGES = (
    ('en', 'English'),
    ('ru', 'Russian'),
...
MIGRATION_MODULES = {"sites": "main_service_of_plotters.contrib.sites.migrations"}
