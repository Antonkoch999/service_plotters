...
class CrashReport(models.Model):
    ...
    user_crash_date = models.CharField(max_length=50, default="",
                                       verbose_name='Crash Date')
    app_version_name = models.CharField(max_length=50, default="",
                                        verbose_name='Version Name')
    user_app_start_date = models.CharField(
        max_length=50, default="",
        verbose_name='Application Start Date')
    settings_global = models.TextField(default="",
                                       verbose_name='Global Settings')
    build = models.TextField(default="")
    settings_secure = models.TextField(default="",
                                       verbose_name='Secure Settings')
    ...
    app_version_code = models.CharField(max_length=50, default="",
                                        verbose_name='Version Code')
    is_silent = models.CharField(max_length=50, default="")
    custom_data = models.TextField(default="")
    description = models.TextField(default="")
    solved = models.CharField(max_length=10, choices=REPORT_STATUS,
                              default="unsolved", verbose_name='Status')
    created = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return 'Device: %s %s - Android: %s - Application: %s Version: %s' % (
               self.brand, self.product, self.android_version,
               self.app_version_name, self.app_version_code)
